...
import Games from "./class/Games.js";
let data;
try {
  data = readFileSync("./src/game/data/games.json", "utf-8");
} catch (err) {
  data = readFileSync("./src/game/data/default.json", "utf-8");
}
export const games = new Games(JSON.parse(data));
